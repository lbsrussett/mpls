...
if __name__ == '__main__':
    ...
    encap_tbl_D = {0:True, 1:True, 2:False, 3:False} #format= in_interface#:encapsulate? #table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {0:True, 1:True, 2:False , 3:False} #format= in_interface#:forward?    # table used to forward MPLS frames
    decap_tbl_D = {0:False, 1:False, 2:True, 3:True} #format= in_interface#:decapsulate?   # table used to decapsulate network packets from MPLS frames
    ...
    frwd_tbl_D = {0:True, 1:True} #format= in_interface#:forward?    # table used to forward MPLS frames
    decap_tbl_D = {0:False, 1:False} #format= in_interface#:decapsulate?   # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {0:True, 1:True} #format= in_interface#:encapsulate?   
